...
public class DeductionPageTestClass extends BaseClass {
  ...
  public void verifyNewDeductionIsAdded() throws IOException {
	  ...
	  dpc.addNewDeduction(ExcelReadClass.readStringData(69, 1), ExcelReadClass.readStringData(70, 1), ExcelReadClass.readStringData(71, 1));
	  ...
	  //System.out.println("Â£" + String.format("%,.2f", Double.parseDouble(expected_amt)));
